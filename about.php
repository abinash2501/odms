...
{               ?>
      <div class="aboutborder">
		 <h2 style="color:rgb(6, 0, 87)"><?php  echo htmlentities($row->PageTitle);?></h2>
		 <div class="about-main">
			 ...
			 <h4><p style="color:rgb(6, 0, 87)"><?php  echo $row->PageDescription;?></p></h4>
		 ...
		 <div class="latest">
			 ...
			 <div class="pic start">
				 ...
				 <p style="color:black;">Suspendisse posuere enim eu ante scelerisque, vehicula turpis.</p>
			 </div>
			 <div class="pic">
