...
if($query->rowCount() > 0)
{ ?>
 <table border="1" style=;" class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
<tr>
...
<tr>
    <td style="color:black !important"><?php  echo $row->BookingID;?></td> 
    <td style="color:black !important"><?php  echo $row->Name;?></td>
    <td style="color:black !important"><?php  echo $row->MobileNumber;?></td>
    <td style="color:black !important"><?php  echo $row->Email;?></td>
