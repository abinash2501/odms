...
{               ?>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu"><i class="si si-volume-2"></i><span class="sidebar-mini-hide"></span>DJ Services</a>
                                    <ul>
                                        <li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-users"></i><span class="sidebar-mini-hide">Contact Us Queries</span></a>
                                    <ul>
                                        <li>
                                ...
                                <li>
                                    <a  href="between-dates-report.php"><i class="si si-doc"></i><span class="sidebar-mini-hide">B/w Dates Report</span></a>
